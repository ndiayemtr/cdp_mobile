...
class APi {
  ...
  static addPlainte(Map data) async {
    final response = await http
        .post(Uri.parse(Url.addPlainte), body: {'data': jsonEncode(data)});
    print(response.body);
...
class Url {
  ...
  static String addPlainte =
      "https://cdpmobile.000webhostapp.com/mobile/plainte.php";
}
